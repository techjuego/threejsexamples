...
export default class ViewCubeControls extends THREE.EventDispatcher {
  ...
  _animate() {
    ...
    if (alpha == 1) {
      this._animation = null;
      // Faces 1-6 map to TOP, FRONT, RIGHT, BACK, LEFT, BOTTOM
      const isOrtho = [1, 2, 3, 4, 5, 6].includes(this.targetFace);
      this.dispatchEvent({
        type: 'snap-complete',
        isOrtho,
...
function createTextSprite(text, props) {
  ...
  // Use CanvasTexture for better compatibility with newer Three.js
...
var CORNER_FACES = [
  { name: FACES.TOP_FRONT_RIGHT_CORNER }, { name: FACES.TOP_BACK_RIGHT_CORNER },
  { name: FACES.TOP_BACK_LEFT_CORNER }, { name: FACES.TOP_FRONT_LEFT_CORNER },
  { name: FACES.BOTTOM_BACK_RIGHT_CORNER }, { name: FACES.BOTTOM_FRONT_RIGHT_CORNER },
  { name: FACES.BOTTOM_FRONT_LEFT_CORNER }, { name: FACES.BOTTOM_BACK_LEFT_CORNER }
];
var EDGE_FACES = [
  { name: FACES.TOP_FRONT_EDGE }, { name: FACES.TOP_RIGHT_EDGE },
  { name: FACES.TOP_BACK_EDGE }, { name: FACES.TOP_LEFT_EDGE },
  { name: FACES.BOTTOM_BACK_EDGE }, { name: FACES.BOTTOM_RIGHT_EDGE },
  { name: FACES.BOTTOM_FRONT_EDGE }, { name: FACES.BOTTOM_LEFT_EDGE },
];
var EDGE_FACES_SIDE = [
  { name: FACES.FRONT_RIGHT_EDGE }, { name: FACES.BACK_RIGHT_EDGE },
  { name: FACES.BACK_LEFT_EDGE }, { name: FACES.FRONT_LEFT_EDGE }
];
